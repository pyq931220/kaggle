...
test_data.repartition(num_partitions).persist(pyspark.StorageLevel.MEMORY_ONLY)
...
train_vectors = pipemodel.transform(train_data).select("label","pcafeatures")
